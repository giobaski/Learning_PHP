<?php
  ...
  {
    $points = 0;
    foreach ( $_POST['question'] as $questionId => $optionId )
    {
      if ($quizz[$questionId]['correct_option'] == $optionId)
      {
        $points += 1;
      }
    }
...
<body>
  ...
  <form action="" method="post">
    ...
    <p>
      <label>
      <input type="radio" name="question[<?=$questionId?>]" value="<?=$optionId?>"> <?= $option ?>
      </label>
    </p>
    <?php endforeach; ?>
